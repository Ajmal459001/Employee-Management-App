    ...
    <div style={{height:'280px',paddingTop:'30px'}} className='mt-5 bg-primary px-5 px-auto w-100'>
      <div className="d-flex justify-content-between">
        ...
        <div style={{width:'400px'}} >
          <h5 className='text-info'> <i class="fa-solid fa-users-gear me-2"></i>EMPLOYEE MANAGEMENT APP</h5>
      ...
      <p className='text-center mt-3'>Copyright &copy; ajmal, EMPLOYEE MANAGEMENT APP. Built with React</p>
    </div>
  )
}
