...
const View = ({addResponseFromHome}) => {
  ...
  return (
    <>
      <h3 className='container text-white text-center'>EMPLOYEE LIST</h3>
      {editEmployee && (
        <div className="container">
          <h5 className='text-warning'>Edit Employee</h5>
        ...
        <tbody>
          {
            ...
            allEmployees?.map((employeeDetails,index)=>(
              <tr>
                ...
                <td><span className='text-info'> {employeeDetails?.email} </span></td>
